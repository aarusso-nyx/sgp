...
describeRlsSmokeSpec({
  ...
  assertionSummary: [
    ...
    '2. portal.paystub.read can read only the current tenant through sgp_tenant_matches on hr.competence_period, payroll.employee_payroll_item, and public.generated_report_file.',
