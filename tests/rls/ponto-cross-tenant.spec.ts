...
describeRlsSmokeSpec({
  title: 'Ponto Cross Tenant',
  specFile: 'tests/rls/ponto-cross-tenant.spec.ts',
  tenantAInsertEvidence: ['INSERT INTO '],
  tenantBZeroRowEvidence: ['Expected tenant B to see 0'],
  assertionSummary: [
    'Exercised by npm run db:smoke through the PONTO-01 migration and RLS coverage check.',
    'Assertions:',
    '1. ponto.day_schedule, ponto.work_schedule, and ponto.time_record force RLS and filter rows with sgp_tenant_matches(tenant_id).',
