import { SalaryHistoryController } from '../src/avaliacao/salary-history/salary-history.controller';
import { SalaryHistoryService } from '../src/avaliacao/salary-history/salary-history.service';
