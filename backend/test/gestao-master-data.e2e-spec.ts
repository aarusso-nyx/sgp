...
import { JobPositionsController } from '../src/gestao/master-data/master-data.controller';
import { MasterDataService } from '../src/gestao/master-data/master-data.service';
