...
const alignmentPath = resolve(workspaceRoot, 'docs/gov/generated/api/route-alignment.json');
const ALLOWED_STATUSES = new Set(['implemented', 'explicitly_excluded']);
const ROUTE_CONTRACT_AUTHORITY_ROOT = 'docs/eng/';
const FORBIDDEN_ROUTE_AUTHORITY_PREFIXES = [
  'docs/gov/generated/',
  'docs/gov/evidence/',
  'docs/eng/facts/',
  'docs/gov/',
...
function assertDocumentationSemantics(alignment) {
  ...
  if (missingExcludedPrefix.length > 0) {
    ...
    ok(
      'Documentation semantics exclude generated, evidence, facts, governance, user, legacy, and scratch docs from route authority.',
    );
  }
}
