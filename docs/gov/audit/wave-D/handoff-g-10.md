# Wave D Handoff - G.10 Afastamento para mandato classista
...
| ID          | `G.10`                                                                                                             |
| Domain      | Licenças                                                                                                           |
| Feature     | Afastamento para mandato classista                                                                                 |
| Description | Sindicato/entidade                                                                                                 |
| Tier        | `M1`                                                                                                               |
| Presence    | `B`                                                                                                                |
| Owner       | `stynx-framework`                                                                                                  |
| Citation    | CLT                                                                                                                |
| Evidence    | hr.leave_record:929 (type=mandato_classista) · rh/workflows/leaves/leaves.controller.ts:22 · AdminFeaturePage stub |
...
- Replace the current AdminFeaturePage route for `G.10` with a dedicated component.
