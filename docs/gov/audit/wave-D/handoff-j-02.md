# Wave D Handoff - J.02 Aposentadoria voluntária
...
| Feature     | Aposentadoria voluntária                                                                                                          |
| Description | Tempo / idade                                                                                                                     |
| Tier        | `M1`                                                                                                                              |
| Presence    | `B`                                                                                                                               |
| Owner       | `stynx-framework`                                                                                                                 |
| Citation    | CF art. 40; EC 103/2019                                                                                                           |
| Evidence    | hr.retirement_grant:1296; hr.retirement_simulation:1325 · previdenciario/previdenciario.controller.ts:297 · AdminFeaturePage stub |
...
- Replace the current AdminFeaturePage route for `J.02` with a dedicated component.
