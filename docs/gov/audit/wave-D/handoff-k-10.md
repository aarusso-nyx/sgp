...
| ID          | `K.10`                                                                                                                                                                               |
| Domain      | Rescisões                                                                                                                                                                            |
| Feature     | Aviso prévio proporcional                                                                                                                                                            |
...
- `POST /v1/admin/terminations/:id/prior-notice` — OpenAPI-documented controller operation (folha-pagamento/rescisao/prior-notice/prior-notice.controller.ts:17)
