# Wave D Handoff - F.06 Adicional 1/3 constitucional
...
| ID          | `F.06`                                                                                                                                                                    |
| Domain      | Férias                                                                                                                                                                    |
| Feature     | Adicional 1/3 constitucional                                                                                                                                              |
| Description | Terço de férias                                                                                                                                                           |
| Tier        | `M1`                                                                                                                                                                      |
| Presence    | `B`                                                                                                                                                                       |
| Owner       | `stynx-framework`                                                                                                                                                         |
| Citation    | CF art. 7º XVII                                                                                                                                                           |
| Evidence    | payroll.payroll_financial_record:136 (vacation_bonus) · folha-pagamento/payroll/payroll.controller.ts:227 · AdminFeaturePage stub · tests/backend/calc-ferias.e2e-spec.ts |
...
- Replace the current AdminFeaturePage route for `F.06` with a dedicated component.
