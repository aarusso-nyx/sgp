# Wave D Handoff - J.01 Cálculo de proventos de aposentadoria
...
| Feature     | Cálculo de proventos de aposentadoria                                                                                                      |
| Description | Cálculo base                                                                                                                               |
| Tier        | `M1`                                                                                                                                       |
| Presence    | `B`                                                                                                                                        |
| Owner       | `stynx-framework`                                                                                                                          |
| Citation    | EC 103/2019; Lei 9.717/1998                                                                                                                |
| Evidence    | hr.retirement_grant:1296; hr.retirement_rule:1311 · previdenciario/previdenciario.controller.ts:289 · AdminFeaturePage stub previdenciario |
...
- Replace the current AdminFeaturePage route for `J.01` with a dedicated component.
