# Wave D Handoff - G.09 Afastamento para cargo eletivo
...
| ID          | `G.09`                                                                                                                                            |
| Domain      | Licenças                                                                                                                                          |
| Feature     | Afastamento para cargo eletivo                                                                                                                    |
| Description | Mandato eletivo                                                                                                                                   |
| Tier        | `M1`                                                                                                                                              |
| Presence    | `B`                                                                                                                                               |
| Owner       | `stynx-framework`                                                                                                                                 |
| Citation    | Lei 8.112/1990 art. 94                                                                                                                            |
| Evidence    | hr.leave_record:929 (type=cargo_eletivo) · rh/workflows/leaves/leaves.controller.ts:22 · AdminFeaturePage stub · tests/backend/leaves.e2e-spec.ts |
...
- Replace the current AdminFeaturePage route for `G.09` with a dedicated component.
