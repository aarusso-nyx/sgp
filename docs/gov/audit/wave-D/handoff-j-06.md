# Wave D Handoff - J.06 Pensão por morte
...
| Feature     | Pensão por morte                                                                                |
| Description | Cálculo, regras EC 103                                                                          |
| Tier        | `M1`                                                                                            |
| Presence    | `B`                                                                                             |
| Owner       | `SGP+stynx-admin`                                                                               |
| Citation    | EC 103/2019 art. 23                                                                             |
| Evidence    | hr.pension_grant:1095 · previdenciario/previdenciario.controller.ts:321 · AdminFeaturePage stub |
...
- Replace the current AdminFeaturePage route for `J.06` with a dedicated component.
