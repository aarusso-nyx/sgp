...
| public.esocial_spool                      | 20      | message_id                                          | 1   | yes | database/sql/16-esocial-spool.sql       |
...
| public.esocial_spool.actor_login                              | yes | login_identifier          | actor_login                  |
| public.esocial_spool.actor_sub                                | yes | pseudonymous_identifier   | actor_subject                |
| public.esocial_spool.error                                    | yes | operational_error         | esocial_transport_error      |
| public.esocial_spool.payload                                  | yes | regulatory_payload        | esocial_message_payload      |
| public.esocial_spool.response                                 | yes | regulatory_payload        | esocial_message_response     |
| public.esocial_spool.source_ref                               | yes | pseudonymous_identifier   | esocial_source_reference     |
