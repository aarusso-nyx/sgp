...
| esocial.endpoint_circuit_state            | 6       | endpoint_url                                        | 0   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.esocial_totalizer                 | 8       | tenant_id, competence, kind, source_event_recibo    | 1   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.event_retry_schedule              | 7       | tenant_id, event_id                                 | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.response_classification           | 5       | response_code                                       | 0   | no  | database/sql/10-02-esocial-ddl.sql      |
| esocial.s1200_emission_state              | 8       | tenant_id, payroll_run_id, employee_id              | 0   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s1202_emission_state              | 8       | tenant_id, payroll_run_id, employee_id              | 0   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s1210_emission_state              | 8       | tenant_id, payment_batch_id, employee_id            | 0   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s1299_emission_state              | 9       | tenant_id, competence                               | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s1xxx_dispatch_state              | 7       | tenant_id, event_kind, source_entity_id             | 1   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2200_emission_state              | 7       | tenant_id, employee_id                              | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2205_pending_alteration          | 11      | id                                                  | 4   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2205_trigger_field               | 2       | field_path                                          | 0   | no  | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2210_pending                     | 7       | tenant_id, cat_emission_id                          | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2220_pending                     | 7       | tenant_id, aso_record_id                            | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2230_pending                     | 11      | id                                                  | 1   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2240_pending                     | 8       | tenant_id, environmental_exposure_id, trigger_event | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2298_event                       | 9       | id                                                  | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2299_pending                     | 11      | id                                                  | 3   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s2306_event                       | 8       | id                                                  | 2   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.s3000_request                     | 15      | tenant_id, request_id                               | 3   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.submission_batch                  | 15      | tenant_id, batch_id                                 | 1   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.tenant_certificate                | 13      | tenant_id, certificate_id                           | 1   | yes | database/sql/10-02-esocial-ddl.sql      |
| esocial.xsd_validation_failure            | 7       | tenant_id, attempt_id                               | 1   | yes | database/sql/10-02-esocial-ddl.sql      |
...
| hr.employment_link                        | 15      | id                                                  | 4   | yes | database/sql/10-05-hr-ddl.sql           |
...
| public.esocial_event                      | 29      | id                                                  | 2   | yes | database/sql/10-10-public-ddl.sql       |
...
| aso_record_s2220_missing_idx                               | saude.aso_record                         | no     | tenant_id, status, s2220_event_id) WHERE (status = 'ARCHIVED'::saude.aso_status |
