...
| ESO-F07 | MIT covers inclusion of tax debts in the DCTFWeb flow under the Receita Federal manual.                                  | MIT import/export must carry establishment identifier, tax code, period, base, amount, due date and stable debt identifiers. | [5]      |
