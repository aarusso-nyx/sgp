...
The payroll formula engine is implemented by the backend compiler in `source/backend/src/payroll-engine/formula-compiler.service.ts` and SQL runtime helpers under `source/database/sql/25-payroll-formula-engine.sql`.
