...
const backendCatalogPath = resolve(
  __dirname,
  '../src/iam/permissions/permission-catalog.generated.ts',
);
...
function readSeed(): PermissionSeed {
  ...
  if (codes.length !== 32) {
    throw new Error(
      `permission-catalog.json must contain exactly 32 permissions; found ${codes.length}`,
    );
  }
...
function writeFrontendCatalog(seed: PermissionSeed): void {
  ...
  const entryLines = entries
    ...
    .join('\n');
  const content = `// Generated by backend/scripts/gen-permissions.ts. Do not edit by hand.
