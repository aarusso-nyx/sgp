...
describe('CALC-12 termination payroll golden scenarios (e2e)', () => {
  ...
  it('calculates CLT without cause with current 8 avos, vested vacation, notice, and FGTS fine', async () => {
    ...
    expectAmount(rows, 'RESC_AVISO_PREVIO', '3000.00');
    expectAmount(rows, 'RESC_MULTA_FGTS_40', '1824.00');
  });
